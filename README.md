...
|---|---|
| **The Wake-Up** | The rumble-strip framing: what complacency is (and isn't), victory disease, and the cost of drift |
| **The Drift Check** | A 12-question self-assessment inspired by the book's awareness questions, scored into three zones (Driver's Seat / Cruise Control / Drifting) with personalized next moves — plus a pointer to Chris's official Complacency Assessment Profile at [drift2drivequiz.com](https://drift2drivequiz.com) |
| **The Seven-Step Framework** | An interactive mile-marker journey through Clarity, Gathering, Filtering, Guidance, Relationships, Action, and Evaluate — each step with its key concepts, traps, quotes, and a **working tool**: |
...
| **30-Day Drive Challenge** | One small daily action per day — a full lap through the framework in 30 days, with progress tracking |
| **Connect** | Links to the official assessment, Maxwell Leadership, and the book, plus an email-capture form ready to wire up |
